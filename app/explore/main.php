...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		{				
			...
			$posts_list = $this->model('posts')->get_posts_list('article', $_GET['page'], get_setting('contents_per_page'), $_GET['sort_type'], null, $category_info['id'], $_GET['answer_count'], $_GET['day'], $_GET['is_recommend']);
		}
